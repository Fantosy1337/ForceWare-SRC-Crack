...
public class Keybind extends Component
{
    ...
    public void renderComponent() {
        ...
        Minecraft.func_71410_x().field_71466_p.func_175063_a(this.binding ? "Press a key..." : ("Key: " + Keyboard.getKeyName(this.parent.mod.getKey())), (float)(this.parent.parent.getX() + 7), (float)(this.parent.parent.getY() + this.offset + 2), -1);
    }
